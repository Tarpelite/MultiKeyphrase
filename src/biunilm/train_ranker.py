...
from pytorch_pretrained_bert.modeling import BertForPreTrainingLossMask, BertForSentenceRanker
from pytorch_pretrained_bert.optimization import BertAdam, warmup_linear

from nn.data_parallel import DataParallelImbalance
import biunilm.seq2seq_loader as seq2seq_loader
from utils_concat import ConcatDataset, TitleDataset, TitleLead1Dataset, SingleTrainingDataset, ScoreDataset, Preprocess4Seq2cls
...
def main():
    ...
    DatasetFunc = ScoreDataset



    if args.do_train:
        print("Loading Train Dataset", args.data_dir)
        bi_uni_pipeline = [seq2seq_loader.Preprocess4Seq2cls(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys(
    ...
    if args.do_train:
        ...
        for i_epoch in trange(start_epoch, int(args.num_train_epochs)+1, desc="Epoch", disable=args.local_rank not in (-1, 0)):
            ...
            for step, batch in enumerate(iter_bar):
                ...
                loss = model(input_ids, segment_ids, input_mask, lm_label_ids, labels)
